...
async function updateFaction(id, factionData) {
  try {
    ...
    if (factionData.name) dataToUpdate.name = factionData.name;
    if (factionData.tag) dataToUpdate.tag = factionData.tag;
    if (factionData.respect !== undefined) dataToUpdate.respect = factionData.respect;
    if (factionData.leader_id) dataToUpdate.leader_id = factionData.leader_id;
    if (factionData.co_leader_id) dataToUpdate.co_leader_id = factionData.co_leader_id;
    if (factionData.member_count !== undefined) dataToUpdate.member_count = factionData.member_count;
