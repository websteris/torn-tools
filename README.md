...
URL-encoded). A request whose body can't be parsed — missing/unsupported
`Content-Type`, no body at all, or malformed JSON — is rejected with
**`400 {"error": "malformed or missing request body"}`**. One uniform convention
