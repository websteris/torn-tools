 ...
 * @param {string} [apiKey] - Optional API key, will use default if not provided
 * @param {string|number} [factionId] - Faction ID (defaults to the key's own faction)
 * @param {Array<string>} [selections] - Optional selections to request
 * @returns {Promise<Object>} Faction data
 */
...
// The class is the primary export so consumers can `new TornApiClient()`.
// The standalone helpers are attached as named exports for callers that
// import them directly (e.g. `const { getUserData } = require('./client')`).
module.exports = TornApiClient;
module.exports.TornApiClient = TornApiClient;
module.exports.getUserData = getUserData;
module.exports.getWarOpponents = getWarOpponents;
module.exports.getFactionData = getFactionData;
